  ...
  render() {
    ...
    return (
      <div className="mx-auto max-w-[560px] px-6 py-16">
        <h1 className="font-serif text-[22px] text-ink">Something broke on this screen.</h1>
        <p className="mt-2 text-[13.5px] leading-relaxed text-muted">
          Your data is safe — this is a display error. Try again, or reload the page.
        </p>
        <pre className="mt-4 max-h-40 overflow-auto whitespace-pre-wrap rounded-lg border border-line-2 bg-rail p-3 font-mono text-[12px] text-ink">
          {error.message}
        </pre>
        <div className="mt-4 flex gap-3">
          <button
            ...
            className="rounded-md border border-line-2 px-3 py-1.5 text-[13px] text-ink transition-colors hover:bg-rail"
          >
            Try again
          </button>
          <button
