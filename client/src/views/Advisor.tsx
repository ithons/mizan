      ...
      <div className="w-full max-w-md space-y-2">
        {prompts.map((prompt) => (
          <button
            ...
            className="w-full text-left px-3 py-2 text-xs text-muted hover:text-text bg-surface shadow-sm border border-border hover:border-border/80 rounded-lg transition-colors"
          >
            {prompt}
          </button>
        ))}
